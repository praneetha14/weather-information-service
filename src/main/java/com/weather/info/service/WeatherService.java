 ...
 *      This class is responsible to fetch weather information from OpenWeather API and store it in RDBMS and redis.
 */
...
public interface WeatherService {
    ...
    /**
     * This method is responsible to fetch weather information from OpenWeatherAPI and store it in RDBMS and redis.
     * This method also performs internal sanity checks on the given input parameters.
     * Returns Weather information from db or redis if already exists in db, else fetches, stores and returns the
     * information by calling OpenWeatherAPI.
     *
     *
